  ...
  return (
    <>
      <PageHeader
        ...
        description="Ce que chaque service détient face à sa cible, article par article. Le comptage est celui déclaré à la commande du jour."
      >
      ...
      <DayInput value={day} basePath="/controle" label="Journée" />
      ...
      {stockControl.length === 0 ? (
        ...
        <div className="space-y-5">
          {stockControl.map((g) => (
            <ControlTable key={g.department.id} group={g} />
          ))}
        </div>
      )}
    </>
